...
function getCardData() {
  let mainBottomContent = document.getElementById("main-bottom-content");
  ...
  for (i = 0; i < data.comments.length; i++) {
    ...
    let contentContainer = document.createElement("div"); // Content container for price, title...
    let cardUsernameSection = document.createElement("div");
    let cardMainContent = document.createElement("div");
    ...
    body.innerHTML = data.comments[i]["body"];

    for (let i = 0; i < 1; i++) {
      let iElement = document.createElement("i");
      iElement.setAttribute("class", "fa-regular fa-thumbs-up");
      cardRating.append(iElement);
    }

    cardRating.setAttribute("class", "rating-icons");

    cardUsernameSection.append(username);
    cardUsernameSection.setAttribute("class", "card-username-section");

    cardMainContent.append(body);
    ...
    mainBottomContent.appendChild(cardDiv);
  }
}
